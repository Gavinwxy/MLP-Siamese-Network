...
transform = transforms.Compose(
    [transforms.Grayscale(),
     transforms.Resize(model.DeepID.input_size),
     transforms.ToTensor(),
    ...
    for loss_func in grid_search['loss_func']:
        for metric in grid_search['metric']:
            for lr in grid_search['lr']:
                ...
                best_valid_loss, best_epoch = train(trainloader, testloader, search_times, model=model, loss_func=loss_func, metric=metric, lr=lr)
